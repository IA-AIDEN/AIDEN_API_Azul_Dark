...
Arquitectura — AIDEN API Azul Dark
...
Guía de integración — AIDEN API Azul Dark

Flujo base

Registrar aplicación y crear API Key.
Enviar solicitud a /v1/chat o /v1/speech (stream opcional).
Recibir webhooks (estados/costos/errores).
Promover sandbox → producción con monitoreo activo.
Seguridad y cumplimiento
docs/assets/security.html
docs/assets/security-schema.svg
Seguridad — AIDEN API Azul Dark
...
Monetización — AIDEN API Azul Dark
